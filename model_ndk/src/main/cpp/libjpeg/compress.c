...
const char *jstringToString(JNIEnv *pInterface, jstring pVoid);
int generateJPEG(BYTE *data, int w, int h, int quality, const char *name, boolean optimize);

//extern "C"
JNIEXPORT jint JNICALL
Java_com_pingan_testndk_ImageCompress_nativeCompressBitmap(JNIEnv *env, jclass type, jobject bitmap,
                                                           jint quality, jstring dstFile_,
                                                           jboolean optimize) {
